...
class EntityManager {
    ...
    map(entityName, result, options = {}) {
        ...
        Object.keys(data).forEach(k => {
            ...
            if (prop && prop.kind === enums_1.ReferenceKind.SCALAR && enums_1.SCALAR_TYPES.includes(prop.runtimeType) && (prop.setter || !prop.getter)) {
            ...
            const pruneToOneRelations = (meta, fields) => {
                return fields.filter(field => {
                    if (!field.includes('.')) {
                        ...
                        return ![enums_1.ReferenceKind.MANY_TO_ONE, enums_1.ReferenceKind.ONE_TO_ONE].includes(meta.properties[field].kind);
                    }
