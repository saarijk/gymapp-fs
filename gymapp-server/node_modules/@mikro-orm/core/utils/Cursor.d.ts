...
import type { EntityKey, EntityMetadata, FilterObject, Loaded } from '../typings';
...
export declare class Cursor<Entity extends object, Hint extends string = never, Fields extends string = '*', Excludes extends string = never> {
    ...
    static getDefinition<Entity extends object>(meta: EntityMetadata<Entity>, orderBy: OrderDefinition<Entity>): (readonly [EntityKey<Entity>, QueryOrder])[];
    /** @ignore */
